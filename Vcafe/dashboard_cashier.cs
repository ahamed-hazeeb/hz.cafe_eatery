...
namespace Vcafe
{
    public partial class dashboard_cashier : UserControl
    {
        ...
        private static dashboard_cashier _dashboard_cashier;
        public static dashboard_cashier _dash_cahier
        {
            get
            {
                if (_dashboard_cashier == null)
                    _dashboard_cashier = new dashboard_cashier();
                return _dashboard_cashier;
                {
        ...
        {
            lbl_cashier.Text = login.uposition;
